...
import org.dpdns.timerverse.ninjabrain.algorithm.stronghold.RingIterator;
import org.dpdns.timerverse.ninjabrain.algorithm.stronghold.StrongholdConstants;

public class ApproximatedDensity {

	private static final int deltaR = 1;
	private static double[] density;
	private static double[] cumulative_r_space;
	...
	public static void init() {
		...
		double sum = 0;
		HashMap<Integer, Integer> offsetWeights = StrongholdConstants.getOffsetWeights();
