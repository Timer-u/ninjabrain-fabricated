package org.dpdns.timerverse.ninjabrain.algorithm.blind;
...
public class BlindResult {
	...
	public static final Pair<Float, String> EXCELLENT = new Pair<Float, String>(1.0f, "Excellent");
	public static final Pair<Float, String> HIGHROLL_GOOD = new Pair<Float, String>(0.9f, "Good (Highroll)");
	public static final Pair<Float, String> HIGHROLL_SUFFICIENT = new Pair<Float, String>(0.7f, "Okay (Highroll)");
	public static final Pair<Float, String> UNDESIRABLE = new Pair<Float, String>(0.5f, "Bad (In Ring)");
	public static final Pair<Float, String> BAD = new Pair<Float, String>(0.2f, "Bad");
	public static final Pair<Float, String> NOT_IN_RING = new Pair<Float, String>(0.0f, "Not in Ring");
	...
	public Pair<Float, String> evaluation() {
		switch (evaluationEnum) {
			...
			case HIGHROLL_GOOD: return HIGHROLL_GOOD;
			case HIGHROLL_OKAY: return HIGHROLL_SUFFICIENT;
			case BAD_BUT_IN_RING: return UNDESIRABLE;
			case BAD: return BAD;
			case NOT_IN_RING: return NOT_IN_RING;
		}
		return NOT_IN_RING;
	}
	...
	private BlindEvaluation getBlindEvaluation() {
		...
		if (highrollProbability / optHighrollProb < 0.01)
