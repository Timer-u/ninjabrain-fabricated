...
public class Chunk {
	...
	public int getOverworldDistance(McVersion version, double playerX, double playerZ) {
	...
	public double[] getAngleErrors(McVersion version, List<EnderEyeThrow> eyeThrows) {
	...
	public double getAngleError(McVersion version, EnderEyeThrow t) {
